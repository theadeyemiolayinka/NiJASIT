...
class IssueRequest extends Request
{
    ...
    public function storeRules(): array
    {
        return [
            ...
            'articles.*.authors.*' => 'required|array',
            'articles.*.authors.*.name' => 'sometimes|required_with:articles.*.authors.*.department|string',
            'articles.*.authors.*.department' => 'sometimes|required_with:articles.*.authors.*.name|string',
